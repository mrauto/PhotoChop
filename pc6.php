<?php 
/* pc6.php July 30  2010  ver 0.3.6.0 pc5
 *
...
?>
		...
		<hr/>
            ...
            <div id="newsSection">
				<form action='pc6.php' method="post" enctype="multipart/form-data" >
                ...
                <p>
					...
					<!--<input name='nw' value ='<?php echo $nw ;?>'  size='1'>   -->
					<br/>
